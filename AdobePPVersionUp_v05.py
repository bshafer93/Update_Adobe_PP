...
class runUpdate:
	"""docstring for runUpdate"""
	def __init__(self, PP_fileLocation):
		def __init__()
		self.PP_fileLocation = PP_fileLocation
	...
	def correct_VersionNames(shotName,self):
	...
	def latestVersion(shotName,self):
	...
	def insert_0(string, index,self):
